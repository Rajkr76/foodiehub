  ...
  return (
    <div className='h-screen '>
      ...
      <div className=" p-1 rounded-xl w-full flex justify-evenly items-center ">
        <select name="size" id="size" className='h-10 w-35   bg-orange-500 rounded-xl px-2 font-mono'>
      ...
      <div className="bg-yellow-400 w-full h-12 flex justify-center items-center mt-5 rounded-xl">
         <Link to="/cart">
        <button className='text-black w-full h-12 rounded-xl font-mono font-bold text-lg active:bg-green-400 transition duration-300 ease-in-out'>
          Add to cart
        </button>  
        </Link>
      </div>
